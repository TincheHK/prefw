 ...
 */
angular.module('schemaForm').directive('sfChanged', function(sfSelect) {
  return {
    require: 'ngModel',
    restrict: 'AC',
    scope: false,
    link: function(scope, element, attrs, ctrl) {
      ...
      if (form && form.onChange) {
        ctrl.$viewChangeListeners.push(function() {
          // TODO: Find the reference to current model instead of value.
        ...
        if (form.copyValueTo) {
          ngModel.$viewChangeListeners.push(function() {
            ...
            angular.forEach(paths, function(path) {
              // TODO: resolves arrayIndex or $index in path
